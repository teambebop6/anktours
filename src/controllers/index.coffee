...
router.post '/reservation', (req, res, next) ->
  ...
  if !contact.phone
    return res.json({status: 400, message: "Damit wir Sie kontaktieren können, geben Sie bitte eine Telefonnummer ein."})
  if !contact.email
  ...
  Trip.findOne({_id: req.body.trip_id}, (err, trip) ->
    ...
    sendMail(req.transporter, mailOptions, (err) ->
      ...
      return res.json({status: 200, message: "Ihre Reservation ist nun abgeschlossen und wird von uns bearbeitet. Wir melden uns in den nächsten Tagen telefonisch bei Ihnen!"})
    )
  ...
  cars = [
    {
      name: 'Setra 516 HDH'
      color: ''
      images: [ 'hdh_1.png','hdh_2.png','hdh_3.png','hdh_4.png','hdh_5.png','hdh_6.png','hdh_7.png','hdh_8.png', 'hdh_9.png' ]
      filter: true
      techs: [
    ...
    },
    {
      ...
      features: [
        {title: 'Sitzplätze', icon: 'ui soccer icon', description: '52 Sitzplätze (umbaubar zu 48 Sitzplätzen mit zwei Clubtischen)'}
        {title: 'Bordküche', icon: 'ui food icon'}
        {title: 'Kaffeemaschine', icon: 'ui coffee icon', description: 'Nespresso'}
    ...
    },
    {
      ...
      images: ['kleinbus_1.jpg','kleinbus_2.jpg','kleinbus_3.jpg','kleinbus_4.jpg','kleinbus_5.jpg','kleinbus_6.jpg','kleinbus_7.jpg'
      ]
    },
    {
      name: 'Postauto'
